...
if __name__ == '__main__':
    ...
    python_script = requests.get(
        "https://raw.githubusercontent.com/JohnChen97/CMPUT404_lab1/main/lab1_python_script.py"
    )
    source_code = requests.get(
        'https://github.com/JohnChen97/CMPUT404_lab1/blob/main/lab1_python_script.py'
    )
    sys.stdout.write(
